...
export default function AdditionalInfoStep({ formData, updateFormData, registerState }: AdditionalInfoStepProps) {
    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
        ...
        <div className="flex space-x-2">
          ...
          />
          <Button type="button" onClick={handleAddLink} disabled={!newLink}>
